        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Your name here" value="<?= $user['firstname']; ?>" required>              
            </div>
            <div class="form-group">
              <label for="lastname">Last name <sup class="text-danger">*</sup></label>
              <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Your last name here" value="<?= $user['lastname']; ?>" required>              
            </div>
            <div class="form-group">
              <label for="age">Age <sup class="text-danger">*</sup></label>
              <input type="text" class="form-control" id="age" name="age" placeholder="Your age here" value="<?= $user['age']; ?>">              
            </div>
            <div class="form-group">
              <label for="email">Email <sup class="text-danger">*</sup></label>
              <input type="text" class="form-control" id="email" name="email" placeholder="Your email here" value="<?= $user['email']; ?>" required>              
            </div>
            <div class="form-group">
              <label for="mobile">Mobile</label>
              <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Your mobile here" value="<?= $user['mobile']; ?>">              
            </div>
            <div class="form-group">
              <label for="hobbie">Hobbie</label>
              <input type="text" class="form-control" id="hobbie" name="hobbie" placeholder="Your hobbie here" value="<?= $user['hobbie']; ?>">              
            </div>
            <div class="form-group">
              <label for="username">Username <sup class="text-danger">*</sup></label>
              <input type="text" class="form-control" id="username" name="username" placeholder="Chose your username" value="<?= $user['username']; ?>" readonly required>              
            </div>
            <div class="form-group">
              <label for="password">Password <sup class="text-danger">*</sup></label>
              <input type="password" class="form-control" id="password" name="password" placeholder="Chose your password" value="">              
            </div>
          </div> 
